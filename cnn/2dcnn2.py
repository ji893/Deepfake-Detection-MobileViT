...
def main():
    """메인 함수"""
    print("="*60)
    print("2D CNN 딥페이크 탐지 학습 (K-Fold 5 교차 검증 + 8:1:1 분할)")
    print("="*60)
    ...
    df.to_csv(output_dir / "2dcnn_kfold_source_wise_results.csv", index=False, encoding='utf-8-sig')
...
def plot_results(all_results):
    ...
    plt.tight_layout()
    plt.savefig('results/2dcnn_kfold_source_wise_comparison.png', dpi=300, bbox_inches='tight')
    print("\n시각화 결과가 저장되었습니다: results/2dcnn_kfold_source_wise_comparison.png")
